  ...
  <div class="app-container">
    ...
    <el-form size="small" class="wt-form-btns" :inline="true" label-width="120px">
      <el-form-item class="search-form-btns">
        ...
        <wt-auth class="search-form-btn" hasAnyPremission="MODULES_DICT:DELETE">
    ...
    <el-table :data="result.list" class="wt-table" header-row-class-name="wt-table-header-row"
      ...
      <el-table-column label="操作" align="center" width="250px">
        <template slot-scope="scope">
          <wt-auth class="search-form-btn" hasAnyPremission="MODULES_DICT:VIEW">
...
<script>
  ...
  export default {
    data() {
      return {
        formListUrl: '/modules/dict/dictList',
        formDeleteUrl: '/modules/dict/dictDelete',
        form: { //  表单数据
          isListLoading: true,
          formData: {
          },
    ...
    methods: {
      ...
      toAdd() {
        ...
        this.$store.dispatch('resetDictDetailData')
