<template>
    <div class="dialog-container wt-dialog-container" v-loading="isAssessorDetailLoading">
      ...
      <el-form-item label="用户名，作为pad端登录账号唯一：" prop="userName" >
          <el-input v-model="detailResult.userName" placeholder="请输入用户名，作为pad端登录账号唯一" ></el-input>
      </el-form-item>
      <el-form-item label="年龄：" prop="age" >
          <el-input v-model="detailResult.age" placeholder="请输入年龄" ></el-input>
      </el-form-item>
    ...
    export default {
      ...
      data() {
        return {
          ...
          rules: {
            userName: [{ required: true, message: '请输入用户名，作为pad端登录账号唯一', trigger: 'blur' }, { validator: this.$wtValidator.ValidatorNotBlank, message: '输入内容不能为空', trigger: 'blur' }],
