<template>
    <div class="dialog-container wt-dialog-container" v-loading="isActivityObjectDetailLoading">
...
<script>
    ...
    export default {
      ...
      data() {
        return {
          form: {
            formUpdateUrl: '/modules/activityObject/activityObjectUpdate',
            formAddUrl: '/modules/activityObject/activityObjectAdd'
          },
      ...
      methods: {
          ...
          this.$refs['form'].validate((valid) => {
            if (valid) {
              this.$confirm('是否添加?', '提示', {
                ...
                that.requestAddActivityObjectDetail()
              }).catch(() => {
        ...
        onSave() {
          ...
          this.$confirm('是否保存?', '提示', {
            ...
            that.requestUpdateActivityObjectDetail()
          }).catch(() => {
            that.isSubmitLoading = false
          })
        },
        /*  ------------------------- 网络请求  -------------------------  */
        requestUpdateActivityObjectDetail() {
          const that = this
        ...
        requestAddActivityObjectDetail() {
          const that = this
          that.isSubmitLoading = true
          request({
      ...
      computed: {
        ...mapState({
          isActivityObjectDetailLoading: state => state.activityObject.isActivityObjectDetailLoading,
          detailResult: state => state.activityObject.activityObjectDetailData
        })
      }
    }
</script>
