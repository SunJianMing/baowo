<template>
    <div
        ...
        v-loading="isAssessorDetailLoading"
    >
        <el-form
            ref="form"
            :model="detailResult"
        ...
        >
            ...
            >
                <el-input
                    v-model="detailResult.drivingYears"
                    placeholder="请输入驾龄年"
                ></el-input>
            </el-form-item>
...
export default {
    ...
    computed: {
        ...mapState({
            isAssessorDetailLoading: state =>
                state.assessor.isAssessorDetailLoading,
