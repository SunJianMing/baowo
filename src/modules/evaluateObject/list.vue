<template>
    <div class='assessorList'>
        ...
        <div class="wt-dialog">
            <el-dialog
                title="查看"
                :visible.sync="isViewDialogVisible"
                :close-on-press-escape="false"
                :close-on-click-modal="false"
                :modal-append-to-body="false"
                lock-scroll
            >
                <AssessorView
                    @wt-dialog-close="isViewDialogVisible = false"
        ...
        <div class="wt-dialog">
            ...
            >
                <AssessorEdit
                    @wt-dialog-close="isEditDialogVisible = false"
...
export default {
    ...
    methods: {
        ...
        toAdd() {
            ...
            if (
                this.$refs.addView !== null &&
                this.$refs.addView !== undefined
            ) {
        ...
        toView(rowData) {
            ...
            if (
                this.$refs.editView !== null &&
                this.$refs.editView !== undefined
            ) {
